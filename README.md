...
There is also a `--custom-plugins` option in which you can bring your own plugins, e.g. `detect-secrets scan --custom-plugins testing/custom_plugins --custom-plugins testing/hippo_plugin.py`.
